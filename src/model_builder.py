...
def model_efficientnet(pretrained=True, num_classes=10):
    model = timm.create_model('tf_efficientnetv2_s_in21ft1k', pretrained=pretrained)
...
def model_efficientformer(pretrained=True, num_classes=10):
    model = timm.create_model('efficientformerv2_s0', pretrained=pretrained, num_classes=num_classes)
    ...
    if hasattr(model, 'head'):
        ...
        raise AttributeError("Model doesn't have a 'head' or 'classifier' attribute")
